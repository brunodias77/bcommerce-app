                ...
                <div className="flex items-center justify-between gap-x-4 ">
                    <div className=" w-full border-r-[1px] border-[#E5E7EB]  pr-4 flex items-center justify-center gap-x-4">
                        ...
                        <div className="flex flex-col  gap-x-2">
                            <h2 className="text-black-400 font-bold text-sm">Frete grátis</h2>
                    ...
                    <div className=" w-full border-r-[1px] border-[#E5E7EB] pr-4 flex items-center justify-center gap-x-4">
                        <DevolutionIcon width={25} height={25} color="#2d2926" />
                        <div className="flex flex-col  gap-x-2">
                            <h2 className="text-black-400 font-bold text-sm">Muito fácil de devolver</h2>
                            <span className="text-gray-secondary text-xs">
                    ...
                    <div className=" w-full flex items-center justify-center gap-x-4">
                        ...
                        <div className="flex flex-col  gap-x-2 ">
                            <h2 className="text-black-400 font-bold text-sm">Política de reembolso</h2>
                            <span className="text-gray-secondary text-xs">
